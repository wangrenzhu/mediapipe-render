...
namespace Opipe {
    ...
    AndroidDirectAccessFrameBuffer::~AndroidDirectAccessFrameBuffer() {
        if (_imageEGL) {
            Opipe::Log("AHardwareBuffer", "release _imageEGL");
            eglDestroyImageKHR(eglGetDisplay(EGL_DEFAULT_DISPLAY), _imageEGL);
            _imageEGL = nullptr;
        }
        if (_graphicBuf) {
            Opipe::Log("AHardwareBuffer", "release AHardwareBuffer");
            Opipe::AndroidHardwareBufferCompat::GetInstance().Release(_graphicBuf);
            _graphicBuf = nullptr;
...
//            _hardwareBufferReadData = nullptr;
    ...
    void AndroidDirectAccessFrameBuffer::_generateTexture() {
        ...
        Opipe::Log("AHardwareBuffer", "glGenTextures %d", _texture);
        ...
        Opipe::Log("AHardwareBuffer", "finish glGenTextures");
    ...
    bool AndroidDirectAccessFrameBuffer::_generateHardwareBuffer() {
        ...
        Opipe::Log("AHardwareBuffer", "start create  AHardwareBuffer_Desc (%d, %d) ", _width,
                      _height);
        ...
        Opipe::Log("AHardwareBuffer", "AHardwareBuffer_allocate success (%d, %d) stride : %d ",
