...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_weatherfish/a544868cc0efc639ec92cd3dff978586/execroot/mediapipe',
    '/private/var/tmp/_bazel_weatherfish/a544868cc0efc639ec92cd3dff978586',
    'ios_arm64',
    {
        'ios_i386': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/weatherfish/Library/Application Support/Tulsi/0.20220209.88/Bazel',
